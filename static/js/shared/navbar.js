...
//             // Attach the event listener after the navbar is loaded
//             setupSearchBar();
//         })
//         .catch((error) => console.error("Error loading navbar:", error));
// });
...
//         console.log("Search query:", event.target.value); // Debugging output
//     });

//     searchInput.addEventListener("keypress", (event) => {
//         if (event.key === "Enter") {
//             const query = searchInput.value.trim();
//             updateUrlWithQuery(query); // Update the URL
//             handleUrlAndFetchPosts(); // Fetch posts based on query
//         }
//     });
// }
...
//     const newUrl = query ? `${baseUrl}?query=${encodeURIComponent(query)}` : baseUrl;
...
//     console.log("Fetching posts for query:", query); // Debugging
//     // Trigger fetchPosts or similar function
// }
